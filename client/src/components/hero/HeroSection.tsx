...
export default function HeroSection() {
  return (
   <section className="flex flex-col items-center justify-center text-center py-16 px-6 bg-[#FEFBEF] mt-32">
      <h1 className="text-5xl font-bold text-gray-900 leading-tight typing-animation">
        Buy & Sell Safely Within Your<span className="text-orange-500 animate-bounce"> Trusted Network</span>
      </h1>
